// access-control v0.1.0 fd09f305d435b0e41b6a68edf967cc0d6fedc56b
// --
...
const WebrpcHeaderValue = "webrpc@v0.21.0;gen-golang@v0.16.0;access-control@v0.1.0"
...
func WebRPCSchemaHash() string {
	return "fd09f305d435b0e41b6a68edf967cc0d6fedc56b"
}
...
// Schema errors
var (
	ErrUnauthorized     = WebRPCError{Code: 1001, Name: "Unauthorized", Message: "Unauthorized access", HTTPStatus: 401}
	ErrPermissionDenied = WebRPCError{Code: 1002, Name: "PermissionDenied", Message: "Permission denied", HTTPStatus: 403}
	ErrSessionExpired   = WebRPCError{Code: 1003, Name: "SessionExpired", Message: "Session expired", HTTPStatus: 403}
)
