...
//
// webrpc-gen -schema=authcontrol.ridl -target=golang@v0.17.0 -pkg=proto -client -out=./authcontrol.gen.go
package proto
...
const WebrpcHeaderValue = "webrpc@v0.22.0;gen-golang@v0.17.0;authcontrol@v0.9.1"
